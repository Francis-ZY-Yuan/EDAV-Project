...
(In the final version, we will omit solutions here)

We observe so many missing variables.

```{r}
df55 <- foreign::read.spss("./W55_Oct19/ATP W55.sav", to.data.frame=TRUE)
plot_missing(df55, percent = TRUE)
```
```{r}
df33 <- foreign::read.spss("./W33_Mar18/ATP W33.sav", to.data.frame=TRUE)
