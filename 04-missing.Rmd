...
```{r}
df55 <- read.spss("./data/W55_Oct19/ATP W55.sav", to.data.frame=TRUE)
```

Since we have had some questions about this data as below, we are going to investigate the missing or DK(Don't know)/Refuse patterns in the following.
...
## Q1. Opinion toward climate change factor and their attributes
...
## Q2. Opinion toward climate change impact and their attributes
...
## Q3. Opinion toward nuclear power and their attributes
